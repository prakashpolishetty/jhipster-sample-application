...
import com.universty.domain.Address;
import com.universty.repository.AddressRepository;
...
/**
 * REST controller for managing {@link com.universty.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                if (address.getLineOne() != null) {
                    existingAddress.setLineOne(address.getLineOne());
                }
                if (address.getLineTwo() != null) {
                    existingAddress.setLineTwo(address.getLineTwo());
                }
                if (address.getAptNo() != null) {
                    existingAddress.setAptNo(address.getAptNo());
                }
