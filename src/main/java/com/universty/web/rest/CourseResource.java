...
import com.universty.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.universty.domain.Course}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Course> partialUpdateCourse(
        ...
        Optional<Course> result = courseRepository
            ...
            .map(existingCourse -> {
                ...
                if (course.getDegreeType() != null) {
                    existingCourse.setDegreeType(course.getDegreeType());
                }
                if (course.getIsCore() != null) {
                    existingCourse.setIsCore(course.getIsCore());
                }
                if (course.getSpecialization() != null) {
                    existingCourse.setSpecialization(course.getSpecialization());
                }
                if (course.getStartDateOfEnrollment() != null) {
                    existingCourse.setStartDateOfEnrollment(course.getStartDateOfEnrollment());
                }
                if (course.getLastDateOfEnrollment() != null) {
                    existingCourse.setLastDateOfEnrollment(course.getLastDateOfEnrollment());
                }
                if (course.getStartDateOfCourse() != null) {
                    existingCourse.setStartDateOfCourse(course.getStartDateOfCourse());
                }
                if (course.getLastDateOfCourse() != null) {
                    existingCourse.setLastDateOfCourse(course.getLastDateOfCourse());
                }
                if (course.getLastDateOfCourseDrop() != null) {
                    existingCourse.setLastDateOfCourseDrop(course.getLastDateOfCourseDrop());
                }
                if (course.getWaitingList() != null) {
                    existingCourse.setWaitingList(course.getWaitingList());
                }
                if (course.getNumberOfEnrollments() != null) {
                    existingCourse.setNumberOfEnrollments(course.getNumberOfEnrollments());
                }
                if (course.getIsEnrollmentRestricted() != null) {
                    existingCourse.setIsEnrollmentRestricted(course.getIsEnrollmentRestricted());
                }
                if (course.getTeacherID() != null) {
                    existingCourse.setTeacherID(course.getTeacherID());
                }
                if (course.getGraderID() != null) {
                    existingCourse.setGraderID(course.getGraderID());
                }
                if (course.getClassRoomNumber() != null) {
                    existingCourse.setClassRoomNumber(course.getClassRoomNumber());
                }
