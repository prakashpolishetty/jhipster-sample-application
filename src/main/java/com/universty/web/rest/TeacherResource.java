...
/**
 * REST controller for managing {@link com.universty.domain.Teacher}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Teacher> result = teacherRepository
            ...
            .map(existingTeacher -> {
                if (teacher.getFacultyId() != null) {
                    existingTeacher.setFacultyId(teacher.getFacultyId());
                }
                ...
                if (teacher.getPersonalEmailId() != null) {
                    existingTeacher.setPersonalEmailId(teacher.getPersonalEmailId());
                }
                if (teacher.getUniversityEmailId() != null) {
                    existingTeacher.setUniversityEmailId(teacher.getUniversityEmailId());
                }
                if (teacher.getIsActive() != null) {
                    existingTeacher.setIsActive(teacher.getIsActive());
                }
                if (teacher.getDepartmentId() != null) {
                    existingTeacher.setDepartmentId(teacher.getDepartmentId());
                }
                if (teacher.getDateOfJoining() != null) {
                    existingTeacher.setDateOfJoining(teacher.getDateOfJoining());
                }
                if (teacher.getDateOfLeaving() != null) {
                    existingTeacher.setDateOfLeaving(teacher.getDateOfLeaving());
                }
