...
/**
 * REST controller for managing {@link com.universty.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Student> partialUpdateStudent(
        ...
        Optional<Student> result = studentRepository
            ...
            .map(existingStudent -> {
                ...
                if (student.getPersonalEmailId() != null) {
                    existingStudent.setPersonalEmailId(student.getPersonalEmailId());
                }
                if (student.getUniversityEmailId() != null) {
                    existingStudent.setUniversityEmailId(student.getUniversityEmailId());
                }
                ...
                if (student.getDegreeType() != null) {
                    existingStudent.setDegreeType(student.getDegreeType());
                }
                if (student.getIsActive() != null) {
                    existingStudent.setIsActive(student.getIsActive());
                }
                if (student.getIsDegreeCompleted() != null) {
                    existingStudent.setIsDegreeCompleted(student.getIsDegreeCompleted());
                }
                if (student.getCurrentSem() != null) {
                    existingStudent.setCurrentSem(student.getCurrentSem());
                }
