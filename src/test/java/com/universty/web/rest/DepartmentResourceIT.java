...
import com.universty.domain.Department;
import com.universty.domain.enumeration.DepartmentName;
import com.universty.repository.DepartmentRepository;
...
class DepartmentResourceIT {
    ...
    private static final DepartmentName DEFAULT_DEPARTMENT_NAME = DepartmentName.COMPUTERSCIENCEENGINEERING;
    private static final DepartmentName UPDATED_DEPARTMENT_NAME = DepartmentName.ELECTRONICSANDCOMMUNICATIONALENGINEERING;
    ...
    void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.departmentId(UPDATED_DEPARTMENT_ID).departmentName(UPDATED_DEPARTMENT_NAME).isActive(UPDATED_IS_ACTIVE);
        ...
        assertThat(testDepartment.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
    }
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentId(UPDATED_DEPARTMENT_ID).departmentName(UPDATED_DEPARTMENT_NAME).isActive(UPDATED_IS_ACTIVE);
